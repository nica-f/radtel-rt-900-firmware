...
/* Uncomment the line below according to the target BT32F0X device used in your 
   application 
  */
...
/**
 * @brief BT32F0X Standard Peripheral Library version number V1.2.0
   */
#define __BT32F0X_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __BT32F0X_STDPERIPH_VERSION_SUB1   (0x02) /*!< [23:16] sub1 version */
#define __BT32F0X_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __BT32F0X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __BT32F0X_STDPERIPH_VERSION        ((__BT32F0X_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__BT32F0X_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__BT32F0X_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__BT32F0X_STDPERIPH_VERSION_RC))
...
/**
 * @brief BT32F0X Interrupt Number Definition, according to the selected device 
 *        in @ref Library_configuration_section 
 */
#define __CM0_REV                 0 /*!< Core Revision r0p0                            */
#define __MPU_PRESENT             0 /*!< BT32F0X do not provide MPU                  */
#define __NVIC_PRIO_BITS          2 /*!< BT32F0X uses 2 Bits for the Priority Levels */

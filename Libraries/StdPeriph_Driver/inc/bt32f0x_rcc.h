...
#ifndef __BT32F0X_RCC_H
#define __BT32F0X_RCC_H
...
#define IS_RCC_AHB_RMH_PERIPH(PERIPH) ((((PERIPH) & 0xFEA1FFFF) == 0x00) && ((PERIPH) != 0x00))
...
#if defined (BT32F0X_MD) || defined (BT32F030X8)
...
#define RCC_FLAG_V18PWRRMHF              ((uint8_t)0x57)
#define RCC_FLAG_OBLRMH                  ((uint8_t)0x59)
#define RCC_FLAG_PINRMH                  ((uint8_t)0x5A)
#define RCC_FLAG_PORRMH                  ((uint8_t)0x5B)
#define RCC_FLAG_SFTRMH                  ((uint8_t)0x5C)
#define RCC_FLAG_IWDGRMH                 ((uint8_t)0x5D)
#define RCC_FLAG_WWDGRMH                 ((uint8_t)0x5E)
#define RCC_FLAG_LPWRRMH                 ((uint8_t)0x5F)
#define RCC_FLAG_HSI14RDY                ((uint8_t)0x61)

#define IS_RCC_FLAG(FLAG) (((FLAG) == RCC_FLAG_HSIRDY)  || ((FLAG) == RCC_FLAG_HSERDY) || \
                           ((FLAG) == RCC_FLAG_PLLRDY)  || ((FLAG) == RCC_FLAG_LSERDY) || \
                           ((FLAG) == RCC_FLAG_LSIRDY)  || ((FLAG) == RCC_FLAG_OBLRMH) || \
                           ((FLAG) == RCC_FLAG_PINRMH)  || ((FLAG) == RCC_FLAG_PORRMH) || \
                           ((FLAG) == RCC_FLAG_SFTRMH)  || ((FLAG) == RCC_FLAG_IWDGRMH)|| \
                           ((FLAG) == RCC_FLAG_WWDGRMH) || ((FLAG) == RCC_FLAG_LPWRRMH)|| \
                           ((FLAG) == RCC_FLAG_HSI14RDY)|| ((FLAG) == RCC_FLAG_V18PWRRMHF))
...
#if defined (BT32F0XX_MD) || defined (BT32F030X8)
